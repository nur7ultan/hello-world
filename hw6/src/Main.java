...
public class Main {
    public static void main(String[] args) {
        ...
        //todo реализовать ввод пользователем кол-во ингредиентов.
        ...
        if (toadEyesCount >= 3 && ravenBonesCount >= 1) {
            System.out.println("Вы получили элексир Зоркости");
            isCanCook = true;
        }
        if (ravenBonesCount >= 2 && dumplingsCount >= 4) {
            System.out.println("Вы получили элексир Стойкости");
            isCanCook = true;
        }
        if (ghoulTearsCount >= 7 && dumplingsCount >= 1 && toadEyesCount >= 2) {
            System.out.println("Вы получили элексир Скрытности");
            isCanCook = true;
        }
        ...
        if (isCanCook == false) {
            System.out.println("Вы не можете приготовить ни один элекстир");
        }
